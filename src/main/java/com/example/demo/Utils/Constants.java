...
/*
    ...
    //LoRaServer有关接口 Http有关常量
    final public static String HTTP_REQUESTURL_PREFIX = "https://39.106.54.222:8080";
    final public static String HTTP_LORASERVER_USERNAME = "cdx";
    final public static String HTTP_LORASERVER_PASSWORD = "cdxhhhhh";

    //添加设备时的默认配置
    final public static String ADD_DEVICE_DEFAULT_DESCRIPTION = "这是描述";
    final public static String ADD_DEVICE_DEFAULT_DEVICEPROFILEID = "352e8567-2ac5-4300-b94d-1e83e967b768";
